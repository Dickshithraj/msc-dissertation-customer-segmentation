...
SOURCE_FILES = [
    ...
    ("src/clustering.py",          "Stage 3 – Clustering (4 algorithms)"),
    ("src/validation.py",          "Stage 3b – Validation & Stability"),
    ("src/profiling.py",           "Stage 4 – Segment Profiling"),
    ("src/clv.py",                 "Stage 5 – Customer Lifetime Value"),
    ("src/churn.py",               "Stage 6 – Churn Classification"),
    ("src/migration.py",           "Stage 7 – Segment Migration"),
    ("src/notifications.py",       "Stage 8 – Notification Engine"),
    ("src/roi.py",                 "Stage 9 – Monte Carlo ROI"),
    ("app/streamlit_app.py",       "Stage 10 – Streamlit Dashboard"),
